...
**Note**: If you're not familiar with Anchor, you should start by reading the [Introduction to Anchor](learn.blueshift.gg/en/courses/introduction-to-anchor) to familiarize with the core concept that we're going to use in this program.
