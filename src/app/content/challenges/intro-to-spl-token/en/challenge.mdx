![Intro to SPL Token Challenge](/graphics/challenge-banners/intro-to-spl-token.png)
...
- **Initialize Mint**: Initialize the `Mint Account` created using the raw instruction or the abstracted instruction that the SDK has.
