...
const allChallenges: ChallengeMetadata[] = [
  ...
  },
  {
    ...
    difficulty: 1,
    isFeatured: true,
    unitName: "Build a Soulbound NFT",
  ...
  {
    slug: "typescript-build-a-stablecoin",
    language: "Typescript",
    color: "105,162,241",
    difficulty: 1,
    isFeatured: true,
    unitName: "Build a Stablecoin",
    apiPath: "/v1/verify/typescript/build-a-stablecoin",
    requirements: [
      { instructionKey: "create_mint_account" },
      { instructionKey: "init_close_mint_authority" },
      { instructionKey: "init_permanent_delegate" },
      { instructionKey: "init_transfer_fee_config" },
      { instructionKey: "init_transfer_hook" },
      { instructionKey: "init_metadata_pointer" },
      { instructionKey: "init_mint" },
      { instructionKey: "init_metadata_instruction" },
    ],
  },
];
