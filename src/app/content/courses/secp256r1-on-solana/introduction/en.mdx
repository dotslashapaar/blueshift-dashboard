...
Secp256r1 defines a mathematical curve that looks like `y² = x³ - 3x + b`. This creates an oval-like shape with special mathematical properties. There are exactly `2²⁵⁶` valid points on this curve; an astronomically large number.
...
The process begins by selecting a cryptographically secure random number between 1 and 2²⁵⁶, which becomes your private key. 
