...
<ArticleSection name="Initializing the Mint Account" id="initializing-the-mint-acc`ount" level="h2" />
...
<ArticleSection name="Transfer Tokens with the Fee" id="transfer-tokens-with-the-fee" level="h2" />
