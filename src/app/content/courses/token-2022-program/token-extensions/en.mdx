...
- The discriminator of this extension is 1 and is 108 bytes long. 
...
pub const permanent_delegate_extension_header: [u8; 4] = [14, 0, 64, 0];
...
pub const permanent_delegate_extension_header: [u8; 4] = [15, 0, 1, 0];
