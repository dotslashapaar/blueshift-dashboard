...
import { VerificationApiResponse } from "@/hooks/useChallengeVerifier";
        ...
        <AnimatePresence>
          {isPanelOpen && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="not-prose bg-background-card w-[calc(100%-2px)] left-1/2 -translate-x-1/2 rounded-xl min-w-full absolute top-[72px] px-4 lg:px-6 h-[calc(100%-72px)] overflow-y-auto pt-8 flex flex-col lg:gap-y-8 justify-between lg:bg-background/50 backdrop-blur-sm overflow-hidden pb-6"
            >
